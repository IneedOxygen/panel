...
export default () => {
  ...
  return (
    ...
    >
      ...
      >
        Are you sure you want to purchase this resource ({resource})? This will take the credits from your account and
      ...
      <Container className={"j-up lg:grid lg:grid-cols-4 my-10 gap-8"}>
        ...
        <TitledGreyBox title={"How to use resources"}>
          ...
          <p className={"text-xs text-gray-500"}>
            If you have a server that is already deployed, you can add resources to it by going to the &apos;edit&apos;
            tab.
          </p>
          <p className={"font-semibold mt-1"}>Adding to a new server</p>
          <p className={"text-xs text-gray-500"}>
            You can buy resources and add them to a new server in the server creation page, which you can access via the
            store.
          </p>
        </TitledGreyBox>
      </Container>
