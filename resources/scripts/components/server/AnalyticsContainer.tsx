        ...
        <div className={"grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-2"}>
          ...
          <div>
            <ContentBox>
              ...
              <UsageBox progress={memoryUsed} title={"Memory Usage"} content={`${memoryUsed.toFixed(2)}% used`} />
              <UsageBox progress={diskUsed} title={"Disk Usage"} content={`${diskUsed.toFixed(2)}% used`} />
            </ContentBox>
